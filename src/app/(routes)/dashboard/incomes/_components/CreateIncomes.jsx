...
function CreateIncomes({ refreshData }) {
  ...
  const onCreateIncomes = async () => {
    ...
    if (result) {
      ...
      refreshData();
      toast.success("New Income Source Created !", {style: {backgroundColor: "#28a745", color: "#fff" },});
        ...
        <DialogContent>
            ...
            <DialogDescription>
              ...
              <div className="mt-5">
                ...
                <div className="mt-2">
                  ...
                  <Input placeholder="e.g. Youtube" onChange={(e) => setName(e.target.value)}/>
          ...
          <DialogFooter className="sm:justify-start">
            ...
            <DialogClose asChild>
              ...
              <Button disabled={!(name && amount)} onClick={() => onCreateIncomes()} className="mt-5 w-full rounded-full">
