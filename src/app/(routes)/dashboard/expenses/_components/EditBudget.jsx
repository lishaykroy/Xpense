...
function EditBudget({ budgetInfo, refreshData }) {
  ...
  const onUpdateBudget = async () => {
    ...
    if (result) {
      ...
      toast.success("Budget Updated !", {style: {backgroundColor: "#28a745", color: "#fff" },});
        ...
        <DialogContent>
            ...
            <DialogDescription>
              ...
              <div className="mt-5">
                ...
                <div className="mt-2">
                  ...
                  <Input type="number" defaultValue={budgetInfo?.amount} placeholder="e.g. 5000$" onChange={(e) => setAmount(e.target.value)}/>
          ...
          <DialogFooter className="sm:justify-start">
            ...
            <DialogClose asChild>
              ...
              <Button disabled={!(name && amount)} onClick={() => onUpdateBudget()} className="mt-5 w-full rounded-full">
